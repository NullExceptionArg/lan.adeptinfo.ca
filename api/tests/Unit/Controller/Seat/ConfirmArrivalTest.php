...
class ConfirmArrivalTest extends SeatsTestCase
{
    ...
    public function testConfirmArrival(): void
    {
        ...
        $this->actingAs($this->user)
            ->json('POST', '/api/seat/confirm/' . env('SEAT__TEST_ID'), [
                'lan_id' => $this->lan->id
            ])
            ->seeJsonEquals([
                "lan_id" => $this->lan->id,
    ...
    public function testConfirmArrivalSeatLanRelationExists(): void
    {
        ...
        $this->actingAs($this->user)
            ...
            ->seeJsonEquals([
                ...
                'message' => [
                    'seat_id' => [
                        0 => 'The relation between seat with id ' . env('SEAT__TEST_ID') . ' and LAN with id ' . $lan->id . ' doesn\'t exist.',
                    ],
                ]
            ])
            ...
            ->seeJsonEquals([
                ...
                'message' => [
                    'seat_id' => [
                        ...
                        1 => 'The relation between seat with id ' . env('SEAT__TEST_ID') . ' and LAN with id ' . $this->lan->id . ' doesn\'t exist.'
                    ],
                ]
            ])
            ->assertResponseStatus(400);
